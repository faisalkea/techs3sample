/**
 * Created by faisaljarkass on 08/03/2017.
 */
/*
...
public class AwsConsoleApp {
    ...
    private static Logger logger = Logger.getLogger(AwsConsoleApp.class.getName());
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            logger.log(Level.INFO, "You have " + instances.size() + " Amazon EC2 Instance(s) running.");
        } catch (AmazonServiceException ase) {
            //System.out.println("Caught Exception: " + ase.getMessage());
            logger.log(Level.SEVERE, "Caught Exception: " + ase.getMessage());
            //System.out.println("Reponse Status Code: " + ase.getStatusCode());
            logger.log(Level.SEVERE, "Response status: " + ase.getStatusCode());
            //System.out.println("Error Code: " + ase.getErrorCode());
            logger.log(Level.SEVERE, "Error code: " + ase.getErrorCode());
            //System.out.println("Request ID: " + ase.getRequestId());
            logger.log(Level.SEVERE, "Request id: " + ase.getRequestId());
            logger.log(Level.SEVERE, "Raw-response: " + ase.getRawResponse());
        }
        ...
        try {
            ...
            logger.log(Level.INFO, "You have " + sdbResult.getDomainNames().size() + " Amazon simpleDB domain(s) containing a total of " + totalItems + " items.");
        } catch (AmazonServiceException ase) {
            //System.out.println("Caught Exception: " + ase.getMessage());
            logger.log(Level.SEVERE, "Caught Exception: " + ase.getMessage());
            //System.out.println("Reponse Status Code: " + ase.getStatusCode());
            logger.log(Level.SEVERE, "Response Status Code: " + ase.getStatusCode());
            //System.out.println("Error Code: " + ase.getErrorCode());
            logger.log(Level.SEVERE, "Error Code: " + ase.getErrorCode());
            //System.out.println("Request ID: " + ase.getRequestId());
            logger.log(Level.SEVERE, "Request ID: " + ase.getRequestId());
...
//                    "containing " + totalItems + " objects with a total size of " + totalSize + " bytes.");
            logger.log(Level.INFO, "You have " + buckets.size() + " Amazon S3 bucket(s), " +
                    "containing " + totalItems + " objects with a total size of " + totalSize + " bytes.");
        } catch (AmazonServiceException ase) {
            /*
